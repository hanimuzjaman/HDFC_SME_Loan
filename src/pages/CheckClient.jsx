...
const CheckClient = () => {
  ...
  const [companyType, setCompanyType] = useState(""); // Default to "" for placeholder
  ...
  // CREATE NEW APPLICANT (This function is now technically unused by the Proceed button)
    ...
    <div className="px-8 py-12 max-w-xl mx-auto font-sans">
      ...
      {toggle === "new" && (
        <div className="space-y-4">
          ...
          {/* 🛑 MODIFIED ACTION: Unconditional Link to KYC Upload page */}
          <Link 
            to="/kyc-upload" 
            className={`w-full py-2 rounded-md flex items-center justify-center gap-2 transition bg-[#002244] hover:bg-[#002244] text-white`}
          >
            Proceed to KYC <FiArrowRightCircle />
          </Link>
...
//           <Link to="/kyc-upload" className="w-full py-2 rounded-md flex items-center justify-center gap-2 transition bg-[#002244] hover:bg-[#002244] text-white">
//             Proceed <FiArrowRightCircle />
//           </Link>
//         </div>
//       )}
